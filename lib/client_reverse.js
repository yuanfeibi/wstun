...
wst_client_reverse.prototype.start = function(portTunnel, wsHostUrl, remoteAddr, extraArgs) {
  ...
  url = "" + wsHostUrl + "/?dst=" + urlWsHostObj.hostname+":"+portTunnel + "&" + new URLSearchParams(extraArgs);
